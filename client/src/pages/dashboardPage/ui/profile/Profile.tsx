    ...
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.row}>
          ...
          <span className="font-mono font-medium">{user.monthlyIncome.toLocaleString()} ₽</span>
        </div>
        <div className={styles.row}>
          <span className="text-gray-500">Накопления:</span>
          <span className="font-mono font-medium">{user.currentSavings.toLocaleString()} ₽</span>
        </div>
        <div className={styles.row}>
          <span className="text-gray-500">Цель в месяц:</span>
          <span className="font-mono font-medium">{user.monthlySavings.toLocaleString()} ₽</span>
        </div>
      </div>
