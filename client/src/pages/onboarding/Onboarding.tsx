      ...
      <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
        ...
        >
          ...
          <input
            ...
            onChange={(e) =>
              setForm({ ...form, monthlySavings: e.target.value })
            }
          />
          ...
          <label className="flex items-center gap-2 p-2 border rounded-lg cursor-pointer">
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, useSavings: e.target.checked })
              }
            />
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white p-4 rounded-lg font-bold mt-6 hover:bg-blue-700"
          >
            Начать
          </button>
        </form>
