...
export const ResultPage = () => {
	...
	const handleSave = async () => {
		...
		await addItem(user.id, {
			...
			coolingPeriodDays: result.daysToWait,
	...
	return (
		<div
			className={clsx(styles.container, isBlocked ? 'bg-red-50' : 'bg-blue-50')}
		>
			<div className={styles.card}>
				...
				<h1
					className={clsx(
						styles.title,
						isBlocked ? 'text-red-600' : 'text-blue-600'
					)}
				>
					{isBlocked
						? 'Покупка Заблокирована'
						: `Охлаждение: ${result.daysToWait} день`}
				</h1>
